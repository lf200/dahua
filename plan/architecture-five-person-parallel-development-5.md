...
status: "Planned"
tags: [architecture, parallel-development, integration, dynamic_test, application_security, flask, benchmark]
---
...
| TASK-016 | 创建 `security_eval/modules/task2/dynamic_test_adapter.py`；封装六类漏洞、EvaluationExample、evaluation_guidelines 和 AttackEngine，保持固定与动态判定口径一致。 |  |  |
