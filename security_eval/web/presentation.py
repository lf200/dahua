...
def build_run_view(
    ...
    return {
        ...
        "request": {
            ...
            "benchmark_version":
                report.request.benchmark_version,

            "authorized_target":
                report.request.authorized_target,
        },
